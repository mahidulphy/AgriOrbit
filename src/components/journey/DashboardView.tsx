    ...
    <div className="min-h-screen bg-[#2E1065] text-[#E9D5FF] flex flex-col font-sans selection:bg-[#A855F7] selection:text-white">
      ...
      <header className="sticky top-0 z-40 bg-[#2E1065]/95 backdrop-blur-md border-b border-[#6D28D9]/40">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-18 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1 bg-[#3B0764] p-1 rounded-xl border border-[#6D28D9]/40 text-xs font-bold">
            <button
              onClick={() => setActiveTab('overview')}
              className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${
                activeTab === 'overview' ? 'bg-[#A855F7] text-white shadow' : 'text-[#E9D5FF]/80 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${
                activeTab === 'conditions' ? 'bg-[#A855F7] text-white shadow' : 'text-[#E9D5FF]/80 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${
                activeTab === 'crops' ? 'bg-[#A855F7] text-white shadow' : 'text-[#E9D5FF]/80 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg transition cursor-pointer ${
                activeTab === 'rotation' ? 'bg-[#A855F7] text-white shadow' : 'text-[#E9D5FF]/80 hover:text-white'
              }`}
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#3B0764] hover:bg-[#6D28D9] border border-[#6D28D9]/60 text-xs font-medium text-white transition cursor-pointer"
            >
              <MapPin className="w-3.5 h-3.5 text-amber-300" />
              <span>{upazilaName}, {language === 'en' ? district.nameEn.split(' ')[0] : district.nameBn.split(' ')[0]}</span>
              <span className="text-[10px] text-[#A855F7] font-bold underline ml-1">Edit</span>
            </button>
            ...
            <button
              onClick={onLogout}
              title="Logout"
              className="p-2 rounded-xl bg-[#3B0764] hover:bg-rose-900/60 border border-[#6D28D9]/50 text-[#E9D5FF] hover:text-rose-200 transition cursor-pointer"
            >
      ...
      <section className="bg-[#250D52] border-b border-[#6D28D9]/40 py-8 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs text-[#E9D5FF]/80 mt-2 font-mono">
              <span className="px-2.5 py-0.5 rounded-full bg-[#3B0764] border border-[#6D28D9]/50 text-cyan-300">
                Lat: {fieldLat}° N, Lng: {fieldLng}° E
              </span>
              <span className="px-2.5 py-0.5 rounded-full bg-[#3B0764] border border-[#6D28D9]/50 text-[#E9D5FF]">
                {district.defaultFieldTag}
              </span>
              <span className="px-2.5 py-0.5 rounded-full bg-[#3B0764] border border-[#6D28D9]/50 text-emerald-300">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <div className="px-3.5 py-2 rounded-xl bg-[#3B0764] border border-[#A855F7]/40 text-xs">
              <span className="text-[#E9D5FF]/60 block text-[10px] uppercase font-bold">
            ...
            <button
              ...
              className="px-3 py-2 rounded-xl bg-[#2E1065] hover:bg-[#6D28D9] border border-[#6D28D9] text-xs font-bold text-[#E9D5FF] transition cursor-pointer"
            >
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex-1 space-y-12">
        ...
        <section>
          <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#A855F7] mb-3">
              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#E9D5FF]/80 mt-1 leading-relaxed">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {/* NASA POWER CARD (White compact card) */}
            <div className="bg-white text-slate-900 rounded-2xl p-5 border border-[#E9D5FF] shadow-xl flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-100">
                  <div className="flex items-center gap-1.5">
                    <span className="w-2.5 h-2.5 rounded-full bg-blue-600" />
                    <strong className="font-extrabold text-sm text-slate-900">NASA POWER</strong>
                  </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="text-2xl font-black text-slate-950 font-mono">
                    {power.rainfallMm} <span className="text-xs font-medium text-slate-600">mm / 30-day</span>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 pt-3 border-t border-slate-100 text-xs">
                  <div>
                    ...
                    <span className="text-lg font-black text-slate-900 font-mono">{power.tempC}°C</span>
                    <span className="block text-[10px] text-slate-500">2m Mean air</span>
                  </div>
                  <div>
                    <span className="text-slate-500 block text-[11px] flex items-center gap-1">
                      <span>💧</span>
                    ...
                    <span className="text-lg font-black text-slate-900 font-mono">{power.humidityPct}%</span>
                    <span className="block text-[10px] text-slate-500">Relative moisture</span>
                  </div>
                </div>
              </div>
            ...
            {/* NASA SMAP CARD (White compact card) */}
            <div className="bg-white text-slate-900 rounded-2xl p-5 border border-[#E9D5FF] shadow-xl flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-100">
                  <div className="flex items-center gap-1.5">
                    <span className="w-2.5 h-2.5 rounded-full bg-emerald-600" />
                    <strong className="font-extrabold text-sm text-slate-900">NASA SMAP</strong>
                  </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="text-2xl font-black text-slate-950 font-mono">
                    {smap.surfaceMoisture} <span className="text-xs font-medium text-slate-600">m³/m³ (0-5cm)</span>
                  </div>
                ...
                <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-100 text-xs text-slate-700">
                  <strong className="block text-[11px] text-slate-900 mb-0.5">
            ...
            {/* NASA MODIS CARD (White compact card) */}
            <div className="bg-white text-slate-900 rounded-2xl p-5 border border-[#E9D5FF] shadow-xl flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-100">
                  <div className="flex items-center gap-1.5">
                    <span className="w-2.5 h-2.5 rounded-full bg-purple-600" />
                    <strong className="font-extrabold text-sm text-slate-900">NASA MODIS</strong>
                  </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="text-2xl font-black text-slate-950 font-mono">
                    {modis.ndvi} <span className="text-xs font-medium text-slate-600">/ 1.0 NDVI</span>
                  </div>
                ...
                <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-100 text-xs text-slate-700">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-black text-slate-900 font-mono">{modis.landSurfaceTempC}°C</span>
                  </div>
        ...
        <section className="p-6 sm:p-8 rounded-3xl bg-[#3B0764]/70 border border-[#6D28D9]/50 shadow-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            <div className="p-4 rounded-2xl bg-[#2E1065] border border-[#6D28D9]/40">
              <span className="text-xs text-[#E9D5FF]/70 block mb-1">
                {language === 'en' ? 'Pre-Monsoon Rainfall' : 'প্রাক-বর্ষা বৃষ্টিপাত'}
              </span>
              <div className="flex items-baseline gap-2">
                <span className="text-2xl font-black text-rose-400 font-mono">-24%</span>
                <TrendingDown className="w-4 h-4 text-rose-400" />
              </div>
              <p className="text-[11px] text-[#E9D5FF]/70 mt-1">
            ...
            <div className="p-4 rounded-2xl bg-[#2E1065] border border-[#6D28D9]/40">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-2xl font-black text-amber-300 font-mono">+1.2°C</span>
            ...
            <div className="p-4 rounded-2xl bg-[#2E1065] border border-[#6D28D9]/40">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-2xl font-black text-rose-400 font-mono">-3.4m</span>
                <TrendingDown className="w-4 h-4 text-rose-400" />
              </div>
              <p className="text-[11px] text-[#E9D5FF]/70 mt-1">
            ...
            <div className="p-4 rounded-2xl bg-[#2E1065] border border-[#6D28D9]/40">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-2xl font-black text-amber-300 font-mono">0.82%</span>
                <span className="text-xs text-rose-300 font-semibold">(Low)</span>
              </div>
              <p className="text-[11px] text-[#E9D5FF]/70 mt-1">
